...
industry: technology
evidence_count: 24
evidence_set_hash: 845ff7bb4bd00203
---
...
- Treat simulation as a pre-release gate, not a nice-to-have.
- Split complex agent behavior into smaller sub-agents when prompts become brittle.
- Keep deterministic steps for workflows that cannot tolerate ambiguity.
- Evaluate speech-to-text, model behavior, and text-to-speech separately.
- Use production-like scenarios to decide whether a model is ready.

### Open Questions

- How often do deterministic checks and LLM-as-a-judge disagree?
- How were the reported 80% reduction metrics measured?
- What failure modes still escape the simulation pipeline?
- How much orchestration overhead does the modular sub-agent design add?
- How are privacy and compliance handled in enterprise voice traffic?
...
- How often do deterministic checks and LLM-as-a-judge disagree? (`47e6251434bb` · neutral · open_questions[0]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- How were the reported 80% reduction metrics measured? (`abf81abe75f4` · neutral · open_questions[1]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- What failure modes still escape the simulation pipeline? (`6773373f3e8b` · neutral · open_questions[2]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- How much orchestration overhead does the modular sub-agent design add? (`cd6c397ae69b` · neutral · open_questions[3]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- How are privacy and compliance handled in enterprise voice traffic? (`259ded26bcf0` · neutral · open_questions[4]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
...
- Treat simulation as a pre-release gate, not a nice-to-have. (`0827cc609b98` · supporting · key_lessons[0]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- Split complex agent behavior into smaller sub-agents when prompts become brittle. (`80faf2c174f9` · supporting · key_lessons[1]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- Keep deterministic steps for workflows that cannot tolerate ambiguity. (`9175a9c41919` · supporting · key_lessons[2]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- Evaluate speech-to-text, model behavior, and text-to-speech separately. (`536ee526462e` · supporting · key_lessons[3]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
- Use production-like scenarios to decide whether a model is ready. (`d62ab1af69d3` · supporting · key_lessons[4]; [[sources/parloa-builds-service-agents-customers-want-to-talk-to-01kr11qtpam16gysk8yxpsbspy|Parloa builds service agents customers want to talk to]])
