...
source_title: 'Millions of Calls, One Judge: How We Evaluated Our Voicebot in Production'
source_date: '2026-04-30'
month: 2026-04
company: Artefact and a major French telecom operator
industry: telecom
evidence_count: 23
evidence_set_hash: 64d68f022dd40724
---
...
An end-to-end production evaluation system for a speech-to-speech voicebot, including atomic binary judges, a stratified Golden Dataset, scripted bot-vs-bot scenarios, live dashboards, kill switches, and an annotation queue feeding failures back into training data.
...
- The system was used on a live telecom voicebot handling production traffic at large scale. — "our voicebot does, it is a conversational voicebot deployed for a major telecom operator, currently handling millions of calls per year in production." (stated)
- The team used a two-loop evaluation structure with offline calibration and online monitoring. — "Our evaluation system rests on two pillars: an Offline lab and an Online safety net." (stated)
- The Golden Dataset calibrated judges before production shipment. — "Only once a metric reaches that alignment threshold on the Golden Dataset do we authorize it to ship to production." (stated)
- Transcription quality was a major operational constraint. — "The biggest source of evaluation error wasn’t the judge — it was the transcription." (stated)
